...
| **아직 안 한 검증** | v2.1-tune 기준 RF hold-out 지표 재산출, 고객 반응률 차이, 장기 드리프트 |
...
Task 5  RF 분류기 학습 (8셀, v2.1-tune 기준 hold-out 지표는 재산출 필요)
...
- **RF 학습**: 8셀 학습, 1셀(photo×n3) SKIP. v2.1-tune 라벨 기준 hold-out 정확도는 재산출 필요
